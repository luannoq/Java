public class Main {
    public static void main(String[] args) {
        ...
        produtoFisico1.getCaracteristicas().add(new Caracteristicas("Plataforma", "PS4"));
        produtoFisico1.getCaracteristicas().add(new Caracteristicas("Distribuidora", "From Software"));
